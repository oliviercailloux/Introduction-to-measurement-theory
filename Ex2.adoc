...
== 
La relation “est ami avec” sur un ensemble de gens est-elle une relation d’équivalence ? Considérez vous-même et deux autres personnes de la classe et imaginez trois scénarios différents.
