...
Hasse diagram: stem:[a R b, a ≠ b], corresponds to a line descending from stem:[a] to stem:[b].
...
Each element in an equivalence relation has an associated equivalence class. The set of equivalence classes, called the quotient by stem:[R], is denoted by stem:[ℱ(R) // R]. It partitions (disjointly classifies) stem:[ℱ(R)].
