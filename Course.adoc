...
<<<<<<< HEAD
==== Exercices
TODO: Complete xref:Ex1.adoc[Exercices S1].

Solutions to xref:Sol1.adoc[some of the exercices]; to the xref:Corr1.adoc[control].
...
=== Exercices
xref:Ex1.adoc[Exercices S1], xref:Exam1.adoc[Intermediate control 2025].
...
=== The ≥ relation
* If stem:[R] is a complete preorder and stem:[ℱ(R)] is finite, it is homomorphic to stem:[≥].
